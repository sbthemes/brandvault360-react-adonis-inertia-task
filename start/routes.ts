    ...
    .group(() => {
        ...
        router
            .group(() => {
                ...
                router
                    .get('/products', '#controllers/admin/product_controller.index')
                    .as('products.index')
                router
                    .get('/products/create', '#controllers/admin/product_controller.create')
                    .as('products.create')
                router
                    .post('/products', '#controllers/admin/product_controller.store')
                    .as('products.store')
                router
                ...
                router
                    .get('/options', '#controllers/admin/option_controller.index')
                    .as('options.index')
                router
                    .post('/options', '#controllers/admin/option_controller.store')
                    .as('options.store')
                router
                    .get('/options/:id', '#controllers/admin/option_controller.show')
                    .as('options.show')
                router
